...
import { Text, View, SafeAreaView, Modal, Image, TouchableOpacity, Button } from "react-native";
    ...
    <View style={globalStyles.containerLight}>
      ...
      >
        <Marker coordinate={location}>
          <Image source={require("../assets/ping.gif")} style={{ width: 30, height: 30 }} />
        </Marker>
        <AntDesign onPress={handlePress} style={{ padding: 5 }} name="pluscircle" size={56} color={globalDesign.secondary} />
      </MapView>
      <SafeAreaView>
        <Modal visible={startModal} animationType="fade">
          <Start setStartModal={setStartModal} addRun={navigation.state.params.addRun} navigation={navigation} />
        </Modal>
      </SafeAreaView>
      <View style={globalStyles.footer}>
        <View style={globalStyles.horizontalSpaceAroundFlex}>
          <TouchableOpacity style={globalStyles.center}>
            <MaterialIcons name="location-on" size={38} color={globalDesign.secondary} />
            <Text style={globalStyles.footerTextSecondary}>Start</Text>
          </TouchableOpacity>
          <TouchableOpacity style={globalStyles.center} onPress={navigateToFeed}>
            <MaterialIcons name="playlist-add-check" size={38} color={globalDesign.light} />
